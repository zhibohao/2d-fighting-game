...
NarutoObject::NarutoObject(FightEngine* pEngine, int playerId)
	:CharacterObject(pEngine)
{
	...
	m_image.LoadImage("../Image/Naruto.png");
...
NarutoObject::~NarutoObject()
{
}

void NarutoObject::SetState() {
	GetReady = new PlayerState(0);
	ThoundsPain = new PlayerState(0);
	
	GetReady->SetNumberFrame(5);
	ThoundsPain->SetNumberFrame(1);

	GetReady->SetControl(false);
	ThoundsPain->SetControl(false);
...
void NarutoObject::MoveControl(){
	...
	case 4:
		...
		case 1:
			m_attackW = 32 * 2;
			m_attackH = 11 * 2;
			m_attackX = m_direction ? m_iDrawWidth - 51 * 2 - m_attackW : 51 * 2;
			m_attackY = 41 * 2;
		...
		case 3:
			m_attackW = 32 * 2;
			m_attackH = 11 * 2;
			m_attackX = m_direction ? m_iDrawWidth - 48 * 2 - m_attackW : 48 * 2;
			m_attackY = 41 * 2;
			break;
		}
		break;
	...
	case 6:
		...
		case 1:
			...
			m_attackW = 34 * 2;
			m_attackH = 11 * 2;
			m_attackX = m_direction ? m_iDrawWidth - 49 * 2 - m_attackW : 49 * 2;
			m_attackY = 41 * 2;
			break;
		}
		break;
	case 7:
		...
		case 0:
			...
			break;
		case 1:
			m_dX = m_direction ? m_dX - 18 : m_dX + 18;
			break;
		case 2:
			m_dX = m_direction ? m_dX - 18 : m_dX + 18;
			break;
		case 3:
			m_dX = m_direction ? m_dX - 5 : m_dX + 5;
			m_attackW = 33 * 2;
			m_attackH = 19 * 2;
			m_attackX = m_direction ? m_iDrawWidth - 43 * 2 - m_attackW : 43 * 2;
			m_attackY = 41 * 2;
			break;
		}
		break;
	...
	case 9:
		...
		case 1:
			...
			m_attackW = 24 * 2;
			m_attackH = 54 * 2;
			m_attackX = m_direction ? m_iDrawWidth - 39 * 2 - m_attackW : 39 * 2;
			m_attackY = 23 * 2;
			break;
		case 2:
			m_dX = m_direction ? m_dX - 1 : m_dX + 1;
			m_attackW = 18 * 2;
			m_attackH = 42 * 2;
			m_attackX = m_direction ? m_iDrawWidth - 39 * 2 - m_attackW : 39 * 2;
			m_attackY = 2 * 2;
	...
	case 13:
		...
		case 2:
			...
			break;
		case 5:
			m_dX = m_direction ? m_dX - 20 : m_dX + 20;
			break;
		}
		break;
	case 14:
...
void NarutoObject::AttackJudgment() {
	...
	if (IfRectangleIntersect(enemy->GetDefenseCentreX(), enemy->GetDefenseCentreY(), enemy->GetDefenseW(), enemy->GetDefenseH(), m_dX + m_attackX, m_dY + m_attackY, m_attackW, m_attackH)) {
		...
		case 11:
			...
			break;
		case 5:
			enemy->BeAttacked(12, 8, 15, 3, 0);
			break;
		case 6:
			enemy->BeAttacked(12, 8, 20, 3, 0);
			break;
		case 7:
...
void NarutoObject::DoUpdate(int iCurrentTime) {

	if ((m_currentStateId == 16) && (GetXCentre() >= m_pEngine->GetScreenWidth())) {
		return;
	}
