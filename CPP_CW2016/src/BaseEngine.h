...
public:
	...
	/* Add a new object */
	void AddObject(DisplayableObject* pObject);
...
public:
	...
	*/
	...
	static int SymbolToKeycode(int iSym)
	{
		...
		case SDLK_KP_1: return SDL12_SDLK_NORMAL + 38;
		case SDLK_KP_2: return SDL12_SDLK_NORMAL + 39;
		case SDLK_KP_3: return SDL12_SDLK_NORMAL + 40;
		}
